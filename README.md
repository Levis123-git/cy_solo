...
### 👨🏻‍💻 Passos para Configuração
 ...
 ```bash
	git clone https://github.com/Levis123-git/cy_solo.git 
```
...
-   **Não deve logar quando dados em branco**:
	 ...
	 **Login com sucesso perfil salão**:
	-  Preenche os dados de login válidos e verifica a mensagem de sucesso.
	-  Garante que o usuário foi redirecionado corretamente.
        
-   **Não deve realizar Login com Senha incorreta perfil salão**:    
	-  Tenta logar com senha incorreta e valida a mensagem de erro exibida.

	**Não deve realizar Login com email incorreta perfil salão**:    
	-  Tenta logar com email incorreta e valida a mensagem de erro exibida.
...
-       
      ...
      ### Demonstração 
    [Testes de Login](https://github.com/user-attachments/assets/dd412bdb-dae7-4807-a35f-0e1d92fa0dbb)
